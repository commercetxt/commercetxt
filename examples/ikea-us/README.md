...
> **📦 Full dataset:** Available on [Hugging Face](https://huggingface.co/datasets/tsazan/ikea-us-commercetxt)  
> **📂 This repo:** Sample (16 categories) for demonstration
...
```
examples/ikea-us/
├── commerce.txt                    # Root catalog (all 632 categories)
├── categories/                     # 16 sample categories
│   ├── frames.txt
│   ├── tables-and-desks.txt
│   └── ... (16 files)
├── products/                       # Products from 16 categories
│   ├── frames/
│   │   ├── 00263858.txt
│   │   └── ...
│   └── ... (16 category folders)
└── token_savings_audit.csv        # Token comparison data
```
...
└── token_savings_audit.csv
```

**Download full dataset:**
- 🤗 Hugging Face: https://huggingface.co/datasets/tsazan/ikea-us-commercetxt
